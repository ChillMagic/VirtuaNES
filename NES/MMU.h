...
extern MMU GlobalMMU;

// メモリタイプ
// For PROM (CPU)
constexpr BYTE BANKTYPE_ROM = 0x00;
constexpr BYTE BANKTYPE_RAM = 0xFF;
constexpr BYTE BANKTYPE_DRAM = 0x01;
constexpr BYTE BANKTYPE_MAPPER = 0x80;
// For VROM/VRAM/CRAM (PPU)
constexpr BYTE BANKTYPE_VROM = 0x00;
constexpr BYTE BANKTYPE_CRAM = 0x01;
constexpr BYTE BANKTYPE_VRAM = 0x80;

// ミラータイプ
constexpr BYTE VRAM_HMIRROR = 0x00; // Horizontal
constexpr BYTE VRAM_VMIRROR = 0x01; // Virtical
constexpr BYTE VRAM_MIRROR4 = 0x02; // All screen
constexpr BYTE VRAM_MIRROR4L = 0x03; // PA10 L固定 $2000-$23FFのミラー
constexpr BYTE VRAM_MIRROR4H = 0x04; // PA10 H固定 $2400-$27FFのミラー
