...
void	Mapper082::WriteLow( WORD addr, BYTE data )
{
	switch( addr ) {
		...
		case	0x7EF2:
			if( reg ) MMU.SetVROM_1K_Bank( 0, data );
			else	  MMU.SetVROM_1K_Bank( 4, data );
			break;
		case	0x7EF3:
			if( reg ) MMU.SetVROM_1K_Bank( 1, data );
			else	  MMU.SetVROM_1K_Bank( 5, data );
			break;
		case	0x7EF4:
			if( reg ) MMU.SetVROM_1K_Bank( 2, data );
			else	  MMU.SetVROM_1K_Bank( 6, data );
			break;
		case	0x7EF5:
			if( reg ) MMU.SetVROM_1K_Bank( 3, data );
			else	  MMU.SetVROM_1K_Bank( 7, data );
			break;
		...
		case	0x7EFA:
			MMU.SetPROM_8K_Bank( 4, data>>2 );
			break;
		case	0x7EFB:
			MMU.SetPROM_8K_Bank( 5, data>>2 );
			break;
		case	0x7EFC:
			MMU.SetPROM_8K_Bank( 6, data>>2 );
			break;
		default:
