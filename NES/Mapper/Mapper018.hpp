...
void	Mapper018::Reset()
{
	...
	reg[2] = nes->mmu.PROM_8K_SIZE-2;
	reg[3] = nes->mmu.PROM_8K_SIZE-1;
...
void	Mapper018::Write( WORD addr, BYTE data )
{
	switch( addr ) {
		case	0x8000:
			...
			nes->mmu.SetPROM_8K_Bank( 4, reg[0] );
			break;
		case	0x8001:
		...
		case	0x8002:
			...
			nes->mmu.SetPROM_8K_Bank( 5, reg[1] );
			break;
		case	0x8003:
		...
		case	0x9000:
			...
			nes->mmu.SetPROM_8K_Bank( 6, reg[2] );
			break;
		case	0x9001:
		...
		case	0xA000:
			...
			nes->mmu.SetVROM_1K_Bank( 0, reg[3] );
			break;
		case	0xA001:
		...
		case	0xA002:
			...
			nes->mmu.SetVROM_1K_Bank( 1, reg[4] );
			break;
		case	0xA003:
		...
		case	0xB000:
			...
			nes->mmu.SetVROM_1K_Bank( 2, reg[5] );
			break;
		case	0xB001:
		...
		case	0xB002:
			...
			nes->mmu.SetVROM_1K_Bank( 3, reg[6] );
			break;
		case	0xB003:
		...
		case	0xC000:
			...
			nes->mmu.SetVROM_1K_Bank( 4, reg[7] );
			break;
		case	0xC001:
		...
		case	0xC002:
			...
			nes->mmu.SetVROM_1K_Bank( 5, reg[8] );
			break;
		case	0xC003:
		...
		case	0xD000:
			...
			nes->mmu.SetVROM_1K_Bank( 6, reg[9] );
			break;
		case	0xD001:
		...
		case	0xD002:
			...
			nes->mmu.SetVROM_1K_Bank( 7, reg[10] );
			break;
		case	0xD003:
...
//			}
		...
		case	0xF002:
			data &= 0x03;
			if( data == 0 )	     nes->mmu.SetVRAM_Mirror( VRAM_HMIRROR );
			else if( data == 1 ) nes->mmu.SetVRAM_Mirror( VRAM_VMIRROR );
