...
INT	i;
	...
	prg[0] = nes->mmu.PROM_8K_SIZE-4;
	prg[1] = nes->mmu.PROM_8K_SIZE-3;
	prg[2] = nes->mmu.PROM_8K_SIZE-2;
	prg[3] = nes->mmu.PROM_8K_SIZE-1;
	SetBank_CPU();
...
{
	nes->mmu.SetVROM_8K_Bank( chr[0], chr[1], chr[2], chr[3],
